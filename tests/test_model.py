...
class DummyModel(nn.Module):
    ...
    def save_pretrained(self, path):
        ...
        (p / "adapter_config.json").write_text(json.dumps({"r": 8, "lora_alpha": 16, "target_modules": ["q_proj", "v_proj"]}))
...
def setup_mocks():
    ...
    mock_processor.return_value = {"pixel_values": torch.zeros((1, 3, 768, 768)), "input_ids": torch.tensor([[1, 2, 3]])}
